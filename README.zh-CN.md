...
可执行科学史是核心，但不是唯一壁垒。CyberEinstein 由七层相互增强的能力组成：

| 壁垒 | CyberEinstein 积累什么 | 给研究者带来什么 |
| --- | --- | --- |
...
第一批核心用户是手里有真实开放问题、并且能够判断科学有效性的研究者：

- 青年 PI、博士后、博士生和科研工程师；
- 以理论、计算和数据驱动研究为主的课题组；
- 建设 AI for Science 能力的科研院所与研发团队；
- 需要本地部署、模型可替换和研究过程可审计的组织。
